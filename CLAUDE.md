...
src/
  ...
  components/
    ...
    Settings.jsx          — дни зарплаты (мульти-выбор), установка баланса, сброс данных
  hooks/
...
- **Завтра (tomorrow)** — прогноз на завтра из текущего баланса: balance / (daysUntilPayday - 1). Меняется с каждой транзакцией
...
- **Сброс (resetAll)** — полная очистка localStorage, доступна в настройках с подтверждением
